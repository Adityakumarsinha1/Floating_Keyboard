...
class Keyboard(imeAutoFillService: ImeAuto,viewResId:Int,keyMapping:SparseArray<String>) {
    private var imeAutoFillService:ImeAuto
    ...
    companion object{
        ...
        fun qwerty(imeAutoFillService: ImeAuto):Keyboard{
